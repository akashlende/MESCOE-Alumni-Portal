...
<html lang="en">
	<head>
		...
		<style>hr{border-style:solid;border-width:10px;border-left:none;border-right:none;border-bottom:none;background-color:#a0a0a0}</style>
	...
	<body onscroll="changeNav()">
		<main>
			<div class="position-relative">
				<section class="section section-lg section-hero section-shaped">
					<div class="shape shape-style-1 shape-primary"><span class="span-150"></span> <span class="span-50"></span> <span class="span-50"></span> <span class="span-75"></span> <span class="span-100"></span> <span class="span-75"></span> <span class="span-50"></span> <span class="span-100"></span> <span class="span-50"></span> <span class="span-100"></span></div>
					<div class="container shape-container d-flex align-items-center py-0" style="height:85%">
						<div class="col px-0">
							<div class="row align-items-center justify-content-center">
								<div class="col-lg-6 text-center">
									<h1 class="text-white" id="alumni-page">MESCOE ALUMNI PORTAL</h1>
									<p id="hero" class="lead text-white">Building a strong community!</p>
									<div class="btn-wrapper mt-5"><button type="button" class="btn btn-lg btn-white btn-icon mb-3 mb-sm-0" data-toggle="modal" data-target="#modal-form"><span class="btn-inner--text">LOGIN/REGISTER</span></button></div>
								</div>
							</div>
						</div>
					</div>
					<div class="pl-2" style="position: absolute; z-index: 5; bottom: 120px;">
						...
						<div class="toast d-none" style="opacity: 100%" role="alert" aria-live="assertive" aria-atomic="true" id="toast-1">
						  <div class="toast-header">
						    <i class="fa fa-bell text-default pr-2" aria-hidden="true"></i>
						    <strong class="mr-auto" id='eventnamestack1'>Alumni Meet 2k19</strong>
						    <small class="text-muted pl-2" id="datestack1">11th January, 2019</small>
						...
						<div class="toast d-none" style="opacity: 100%" role="alert" aria-live="assertive" aria-atomic="true" id="toast-2">
						  <div class="toast-header">
						    <i class="fa fa-bell text-default pr-2" aria-hidden="true"></i>
						    <strong class="mr-auto" id='eventnamestack2'>Alumni Meet 2k19</strong>
						    <small class="text-muted pl-2" id="datestack2">11th January, 2019</small>
						    <button type="button" class="ml-2 mb-1 close" 
						    	onclick="document.getElementById('toast-1').classList.add('d-none');
						    	setTimeout(()=>{
						    		document.getElementById('toast-1').classList.remove('d-none');
						  ...
						  <div class="toast-body">
						    <p id="detailsstack3">Event by Developer Students Club. <br>*Venue and Date are subject to change.</p>
						  </div>
						</div>
					</div>
					<div class="separator separator-bottom separator-skew zindex-100">
						<svg x="0" y="0" viewBox="0 0 2560 100" preserveAspectRatio="none" version="1.1" xmlns="http://www.w3.org/2000/svg">
							<polygon class="fill-white" id="separator-polygon" points="2560 0 2560 100 0 100" onscroll='console.log("SCROLL")'></polygon>
						</svg>
					</div>
								...
								<div>
									<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="carousel-item active"><img src="assets/img/1.jpg" class="d-block w-100" alt="..."></div>
											<div class="carousel-item"><img src="assets/img/2.jpg" class="d-block w-100" alt="..."></div>
											<div class="carousel-item"><img src="assets/img/3.jpg" class="d-block w-100" alt="..."></div>
										</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-xs-12 about-company">
							...
							<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.872948636676!2d73.87828531542512!3d18.53464268740087!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c0f855581855%3A0x9bfc35605df36ec5!2sModern%20Education%20Society&#39;s%20College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1576930440650!5m2!1sen!2sin" frameborder="0" style="border:0;height:14rem;width:14rem;border-radius:15px"></iframe>
						</div>
						...
						<div class="col-lg-4 col-xs-12 location">
							...
							<p>Late Prin. V.K. Joag Path, Wadia College Campus, Bund Garden Rd, Pune, Maharashtra 411001</p>
						</div>
					</div>
					<div class="row mt-5 text-center">
						<div class="col copyright">
							<p>
								<medium class="text-white-50">&copy; 2019, Modern Education Society's College of Engineering, Pune</medium>
							</p>
						</div>
					</div>
				</div>
		...
		<script src="assets/js/remember.js"></script><script src="assets/js/loginScript.js"></script>
		<script src="https://unpkg.com/typewriter-effect@latest/dist/core.js"></script>
		<script type="text/javascript">
			var app=document.getElementById("hero"),typewriter=new Typewriter(app,{loop:!0});typewriter.typeString("Building fortis civitas!").pauseFor(1700).deleteChars(15).typeString("a strong community!").pauseFor(890).deleteAll().typeString("Life isn't a matter of milestones, ").pauseFor(1100).typeString("but of moments!").pauseFor(900).deleteAll().typeString("Reconnect. ").pauseFor(400).typeString("Relive. ").pauseFor(500).typeString("Rejoice.").pauseFor(900).start()</script><script>let poly = document.querySelector("#alumni-page");
